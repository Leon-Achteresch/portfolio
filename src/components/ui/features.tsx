                ...
                {data.map((item, index) => (
                  ...
                  >
                    {linePosition === "left" || linePosition === "right" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-top bg-foreground transition-all ease-linear bg-foreground`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    {linePosition === "top" || linePosition === "bottom" ? (
                      ...
                      >
                        <div
                          ...
                          } origin-left bg-foreground transition-all ease-linear bg-foreground`}
                          style={{
                            transitionDuration:
                              currentIndex === index
                                ? `${collapseDelay}ms`
                    ...
                    <div className="relative flex items-center">
                      ...
                      <div>
                        <AccordionTrigger className="pl-0 text-xl font-bold text-foreground leading-6">
                          {item.title}
                        </AccordionTrigger>

                        <AccordionTrigger className="justify-start pl-0 text-left text-[16px] leading-4 text-foreground/60">
                          {item.content}
                        </AccordionTrigger>
                      </div>
                    </div>
            ...
            >
              {data[currentIndex]?.image ? (
                <motion.img
                  ...
                  alt="feature"
                  className="aspect-auto cursor-pointer size-full rounded-xl border border-neutral-300/50 object-contain object-left-top p-1 shadow-lg"
